      ...
      <html>
        <head>
          ...
          <style>
            ...
            .score-badge { background-color: #2E7D32; color: white; padding: 5px 10px; border-radius: 15px; font-weight: bold; display: inline-block; }
        ...
        <body>
          ...
          <div class="section">
            ...
            ${log.notes ? `<p><span class="label">Notes:</span> <span class="value">${log.notes}</span></p>` : ''}
          </div>

          ${analysis ? `
            <h2>AI Analysis</h2>
            <div class="section">
              <p><span class="label">Health Score:</span> <span class="score-badge">${analysis.health_score}/100</span></p>
              <p><span class="label">Classification:</span> <span class="value">${analysis.classification}</span></p>
              <p><span class="label">Summary:</span> <span class="value">${analysis.gut_health_summary}</span></p>
              
              <h3>Detailed Breakdown</h3>
              <p><span class="label">Shape:</span> <span class="value">${typeof analysis.shape_analysis === 'string' ? JSON.parse(analysis.shape_analysis).description : ''}</span></p>
              <p><span class="label">Texture:</span> <span class="value">${typeof analysis.texture_analysis === 'string' ? JSON.parse(analysis.texture_analysis).description : ''}</span></p>
              <p><span class="label">Color:</span> <span class="value">${typeof analysis.color_analysis === 'string' ? JSON.parse(analysis.color_analysis).description : ''}</span></p>
              
              <h3>Vet Recommendation</h3>
              <p class="${analysis.vet_flag ? 'warning' : 'success'}">
